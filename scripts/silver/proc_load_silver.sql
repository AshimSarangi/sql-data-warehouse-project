...
Script Purpose:
    ...
    - Standardizes and cleans data values.
    - Applies business rules and data quality checks.
    - Normalizes and validates data before loading into the Silver layer.
...
BEGIN
	...
	BEGIN TRY
		...
		CASE UPPER(TRIM(prd_line)) 
			...
			WHEN 'T' THEN 'Touring'
			ELSE 'n/a'
		END AS prd_line,									-- Map product line codes into descriptive values
